          ...
          <div key={id} className="">
            ...
            >
              <div className="relative">
                <p className=" absolute -right-4  -top-4  btn  rounded-full py-1 px-3 text-[#BB4D00] font-medium text-sm bg-[#FEF3C6] border-0   ">
                  {product.tagType}
                </p>
              </div>
              <p className=" px-3.5 py-3  border border-[#F2F2F2] rounded-full w-fit">
                {product.icon}
              </p>
